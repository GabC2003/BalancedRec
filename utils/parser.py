...
def parse_args():
    ...
    parser.add_argument('--k', default = [20, 30, 50], type = list,
    ...
    parser.add_argument('--item_g', default = 0.1, type = float,
                        help = 'hyper-parameter for aggregation weight')
    parser.add_argument('--diversity_g', default = 1, type = float,
                        help = 'hyper-parameter for aggregation weight')
    parser.add_argument('--threshold_g',default = 0.2,type=float,
                        help = 'hyper-parameter for personalization')
